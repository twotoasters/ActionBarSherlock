...
public class ActionBarLimitedView extends AbsActionBarLimitedView {
    private static final String TAG = "ActionBarLimitedView";
    ...
    public ActionBarLimitedView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        final int homeResId = //a.getResourceId(
                ...
                R.layout.abs__action_bar_limited_home;//);
    ...
    public void setMenu(Menu menu, MenuPresenter.Callback cb) {
        ...
        if (!mSplitActionBar) {
            ...
            if (mSplitView != null) {
                ...
                menuView.setVisibility(getVisibility());
