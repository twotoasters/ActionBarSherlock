 ...
 * @hide
 */
public class ActionBarLimitedContainer extends FrameLayout {
    ...
    public ActionBarLimitedContainer(Context context) {
        this(context, null);
    }

    public ActionBarLimitedContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void onFinishInflate() {
        ...
        mActionBarView = (ActionBarLimitedView) findViewById(R.id.abs__action_bar);
    }
