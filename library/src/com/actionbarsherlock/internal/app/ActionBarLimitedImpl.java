...
public class ActionBarLimitedImpl extends ActionBar {
    private Context mContext;
    private Context mThemedContext;

    private ActionBarLimitedContainer mContainerView;
    private ActionBarLimitedView mActionView;
    private ActionBarLimitedContainer mSplitView;
    ...
    public ActionBarLimitedImpl(Activity activity, int features) {
    ...
    public ActionBarLimitedImpl(Dialog dialog) {
    ...
    private void init(View decor) {
        ...
        mActionView = (ActionBarLimitedView) decor.findViewById(R.id.abs__action_bar);
        //mContextView = (ActionBarContextView) decor.findViewById(
        //        R.id.abs__action_context_bar);
        mContainerView = (ActionBarLimitedContainer) decor.findViewById(
                R.id.abs__action_bar_container);
        mSplitView = (ActionBarLimitedContainer) decor.findViewById(
    ...
    public View getCustomView() {
        return null;//mActionView.getCustomNavigationView();
    }
    ...
    public int getNavigationMode() {
        return 0;//mActionView.getNavigationMode();
    }
    ...
    public int getSelectedNavigationIndex() {
        /*switch (mActionView.getNavigationMode()) {
            ...
            case NAVIGATION_MODE_LIST:
                return -1;mActionView.getDropdownSelectedPosition();
            default:
                return -1;
        }*/
        return -1;
